...
| Fontes | 0 | **5 por produto** (só reais) |
| Imagens/produto | 1 | 2 |
| H1 (keyword) | 1 | **1 (regra fixa — nunca mais de um)** |
| H2 + H3 | 12 | **~15** |
| Densidade keyword-cabeça | ~1,4% | **1–2% (teto de segurança)** |
...
### Parâmetros recusados (produzem penalização — não aplicar)

| Pedido | Valor seguro adotado | Por quê |
|---|---|---|
| Densidade 3% | **1–2%** | Páginas no topo ficam em 0,5–2%; 3% é sinal de over-optimization |
| Keyword >400× | **~1–2% do total** (≈56–100× em 4–6 mil palavras) | 400× = 6,7–10% de densidade = stuffing = ação manual do Google |
| 5 H1 (1 por pergunta) | **1 H1 único** | Regra técnica de HTML/SEO: só um H1 por página. Perguntas de FAQ = H3 + schema FAQPage |

Os dois primeiros também se contradizem: 400 repetições já significam 6,7–10% de densidade, muito acima dos 3% pedidos. Ambos passam do limite seguro. **Meta correta:** cobrir mais entidades semânticas (termos do campo do produto), não repetir a frase-alvo.
...
- [ ] Densidade keyword-cabeça 1–2% (medir com `grep -o -i`) — nunca 3%+ nem 400 repetições
- [ ] Exatamente 1 H1 por página; perguntas de FAQ como H3
